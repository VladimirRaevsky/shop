    ...
    return (
        ...
        >
            <div className={cls.items}>
                <AppLink to={RoutePaths.main} theme={AppLinkTheme.PRIMARY} className={cls.link}>
                    <HomeSvg className={cls.icon} />
                    <span className={cls.item}>{t('Главная')}</span>
                </AppLink>

                <AppLink to={RoutePaths.about} theme={AppLinkTheme.PRIMARY} className={cls.link}>
                    <AboutSvg className={cls.icon} />
                    <span className={cls.item}>{t('О нас')}</span>
                </AppLink>
            </div>
            <div className={cls.collapsedBtn}>
